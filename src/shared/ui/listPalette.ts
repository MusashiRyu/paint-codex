 ...
 * persisted into the store and rendered later as a bare colour, so writing
 ...
 * the store default had drifted apart into two copies of the same five colours.
 *
...
/** What a list gets when the caller does not pick a colour. */
