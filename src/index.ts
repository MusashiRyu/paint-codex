...
export type { SectionHeadingProps } from './shared/ui/SectionHeading';
export { PaintSummary } from './shared/ui/PaintSummary';
export type { PaintSummaryProps } from './shared/ui/PaintSummary';
