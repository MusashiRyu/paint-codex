...
but this text is the Color Lab announcement rather than a bugfix line, because
for an App Store user the Color Lab *is* new.

That is the opposite of Play's notes for the same versions, which say almost
