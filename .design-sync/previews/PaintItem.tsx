...
export const Row = () => (
  <Panel>
    <PaintItem name="Mephiston Red" brand="Citadel" type="Base Layer" hex="#9B0E05" onRemove={noop} />
  </Panel>
);
...
export const CategorySection = () => (
  <Panel>
    ...
    <PaintItem name="Mephiston Red" brand="Citadel" type="Base Layer" hex="#9B0E05" onRemove={noop} />
    <PaintItem name="Macragge Blue" brand="Citadel" type="Base Layer" hex="#0F4B8F" onRemove={noop} />
    <PaintItem name="Abaddon Black" brand="Citadel" type="Base Layer" hex="#141414" onRemove={noop} />
  </Panel>
);
...
export const LongNameAndNoType = () => (
  <Panel>
    <PaintItem name="Incubi Darkness Contrast Special Edition" brand="Citadel" type="Contrast" hex="#094345" onRemove={noop} />
    <PaintItem name="Gory Red" brand="Vallejo" hex="#810504" onRemove={noop} />
  </Panel>
);
